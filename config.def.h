...
static const float gappxmaxpercent = 0.018; /* gapspx max value in percent */
...
static Key keys[] = {
	...
	{MODKEY|ShiftMask|Mod1Mask,             XK_h,               setcfact,             {.f = +0.25}},
	{MODKEY|ShiftMask|Mod1Mask,             XK_l,               setcfact,             {.f = -0.25}},
	{MODKEY|ShiftMask|Mod1Mask,             XK_o,               setcfact,             {.f =  0.00}},
